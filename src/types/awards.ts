...
export const AWARD_DESCRIPTIONS = {
  Excellence: "The highest honor in VEX Robotics, recognizing overall excellence in building a high-quality robotics program. This award considers robot performance, engineering documentation, and overall an demonstration of excellence.",
