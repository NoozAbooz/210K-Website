...
function RobotModel({ modelPath }: { modelPath: string }) {
  ...
  return (
    <primitive 
      ref={meshRef} 
      object={clonedScene} 
      scale={[0.02, 0.02, 0.02]} // Adjust scale as needed for your model
...
export function OurRobot() {
  ...
  const modelPath = '/models/MOA_CAD.glb'; // Update this path to your actual model file
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl shadow-xl p-6">
                 ...
                 <h3 className="text-xl font-semibold text-gray-800">CAD - v1.0</h3>
               </div>
              
              <div className="h-96 w-full rounded-xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 relative">
                                 <Canvas
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-3 mb-4">
                <div className="h-6 w-6 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full"></div>
                <h3 className="text-xl font-semibold text-gray-800">Robot Specifications</h3>
              </div>
             
              <div className="grid grid-cols-2 gap-4">
                {/* Left Image */}
                <div className="bg-white rounded-xl shadow-lg p-4">
                  <div className="aspect-[8.5/11] rounded-lg overflow-hidden mb-3">
                    <img
                      src="/models/1.png"
